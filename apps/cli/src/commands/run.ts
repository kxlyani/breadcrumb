  ...
  .action(async (args: string[], opts) => {
    ...
    await new Promise<void>((resolve) => {
      ...
      child.on("close", async (code) => {
        ...
        console.log(
          `  ${chalk.dim("Detected:")} ${chalk.yellow(extracted.title)}`,
        );
        console.log();
        ...
        console.log(
          `  ${chalk.green("[y]")} Yes   ${chalk.blue("[e]")} Edit title   ${chalk.dim("[n]")} Skip`,
        );
        console.log();
        ...
        try {
          ...
          console.log(
            chalk.dim(`  View at your Breadcrumb dashboard → Issues`),
          );
          console.log();
        } catch (err: any) {
